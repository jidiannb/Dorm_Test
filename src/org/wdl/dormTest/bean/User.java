package org.wdl.dormTest.bean;
	...
	public class User {
		...
		public String toString() {
			return "User [id=" + id + ", name=" + name + ", passWord=" + passWord + ", stuCode=" + stuCode + ", sex="
					+ sex + ", tel=" + tel + ", dormBuildId=" + dormBuildId + ", dormCode=" + dormCode + ", roleId="
					+ roleId + ", disabled=" + disabled + ", createUserId=" + createUserId + ", dormBuild=" + dormBuild
					...
					+ ", getCreateUserId()=" + getCreateUserId() + ", getDisabled()=" + getDisabled()
					+ ", getDormBuilds()=" + getDormBuilds() + ", getClass()=" + getClass() + ", hashCode()="
